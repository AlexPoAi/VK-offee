...
| PARK.COMM.027 | draft | 2026-04-22 | Александр → Администрация Бахчисарайского района | письмо | Черновик запроса по балансодержателю канализационной трубы | draft | `04-communications/PARK.COMM.027-draft-letter-bahchisaray-district-sewage-pipe (...).md` |
...
6. Отправить запрос в `Администрацию Бахчисарайского района` по балансодержателю/компетенции по трубе
