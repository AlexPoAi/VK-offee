...
| PARK.COMM.030 | draft/source | 2026-04-27 | constantnine, ValerON, Александр | Telegram | Вопрос по скамейкам и урнам для СПОЗУ; рекомендован ответ без расширения благоустройства | draft-response | `04-communications/PARK.COMM.030-spozu-benches-urns-question-april27 (...).md` |
...
2. Ответить проектировщикам по `PARK.COMM.030`: скамейки не закладывать; урна только минимально у входа, если нужна для корректности СПОЗУ
