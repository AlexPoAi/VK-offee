...
| PARK.COMM.026 | draft | 2026-04-22 | Александр → ГУП РК "Вода Крыма" | письмо | Черновик официального запроса по статусу канализационной трубы | draft | `04-communications/PARK.COMM.026-draft-letter-water-crimea-sewage-pipe (...).md` |
| PARK.COMM.027 | draft | 2026-04-22..23 | Александр → Администрация Бахчисарайского района | письмо | Письмо по балансодержателю / статусу канализационной трубы, доведённое до print-ready | next-action | `04-communications/PARK.COMM.027-draft-letter-bahchisaray-district-sewage-pipe (...).md` |
...
16. `PARK.WP.026-draft-message-luks`

## Текущий статус переговоров (22.04.2026)
...
2. Запросить письменную фиксацию причины задержки АГО от ЛУКС
3. Запросить письменное разграничение ДС1 vs ДС3
4. Консультация юриста по оригиналу П240
5. Отправить запрос в `Воду Крыма` по статусу канализационной трубы
6. Подать `PARK.DOC.037` в `Администрацию Бахчисарайского района` и взять отметку о приёме
