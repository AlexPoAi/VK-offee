...
| PARK.COMM.024 | source | 2026-04-17 | Александр, секретарь отдела архитектуры | личная подача | Подача документов АГО в Администрацию | waiting | `04-communications/PARK.COMM.024-ago-submission-april17 (...).md` |
...
15. `PARK.WP.026-draft-message-luks`

## Текущий статус переговоров (17.04.2026)
...
- ⏳ Ожидается присвоение входящего номера (в течение 3 рабочих дней)
- ⏳ Ожидается назначение исполнителя (в течение 3 рабочих дней)
