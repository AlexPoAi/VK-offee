...
## Проектные материалы СПОЗУ

| ID | Дата | Тема | Оригинал | Карточка | Статус |
|---|---|---|---|---|---|
| PARK.DOC.040 | 2026-04-29 | **СПОЗУ — скриншот проекта (1КН, маршруты, привязка)** | Google Drive: `1diDll9Cs-CCkTyBx-UTV23SKW-EJYiU3` (папка СПОЗУ) | — | original-only |
| PARK.DOC.041 | 2026-04-29 | **СПОЗУ — скриншот исправления: прямой маршрут нижний вход → кофейня** | Google Drive: `1uPF4poK_YmrnSeh7RWOXJVG-Xn45pg7a` (папка СПОЗУ) | — | original-only |

**Контекст:** переписка с Константином (проектировщик) 29.04.2026. Решения: 1 лавочка + 2 урны у входов; прямая дорожка нижний вход (парковка) → кофейня; боковой вход с парковки — не делать (1-й этап). СПОЗУ + АР МОДИ сдвинуты по срокам (Валерон, 12:02).
